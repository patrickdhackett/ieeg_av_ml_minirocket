...
csv_path = os.path.join(
    ...
    '13_onevsall_with_permutationontrain_iti.csv'
)
...
for roi in sorted(df['ROI'].dropna().unique()):
    ...
    # top row: all / gamma / Delay1 vs Fix perm
    ...
    # bottom row: Delay1 binom / Delay1 perm / null
    plot_ribbon(axes[1,0], df_dp1bin, "Delay1 (binom-sig)",       n_dp1bin)
    plot_ribbon(axes[1,1], df_dp1perm,"Delay1 (perm p<0.05)",      n_dp1perm)
