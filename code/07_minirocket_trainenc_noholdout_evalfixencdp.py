...
for subject in top_group:
    ...
    for ch in roi_chs:
        ...
        ta     = accuracy_score(y_train,   pipe.predict(X_train))
...
#  save
os.makedirs(os.path.join(model_results_dir, '07_noholdout_evalallperiods'), exist_ok=True)

results_df.to_csv(os.path.join(model_results_dir, '07_noholdout_evalallperiods/ENCTRAIN_evalfixencdp_minirocket_channel_val_accuracies_model4.csv'),
                  index=False)
