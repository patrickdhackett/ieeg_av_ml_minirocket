...
#  sav
results_df.to_csv(os.path.join(model_results_dir, 'MOREROIsminirocket_channel_val_accuracies_model3.csv'),
                  index=False)

filtered_df.to_csv(os.path.join(model_results_dir, 'MOREROISsminirocket_channel_subset_test_accuracies_model3.csv'),
                  index=False)

sig_df.to_csv(os.path.join(model_results_dir, 'MOREROISminirocket_channel_selective_channels_model3.csv'),
                  index=False)
